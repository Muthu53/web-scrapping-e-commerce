...
To use this code you need ScrapingAnt API key. Just go to ScrapingAnt, and Sign In (by clicking TRY NOW button). After that you can find your API key at "Your API token" card at the dashboard page.
...
The file will be saved in a folder from which you run the script: baking_mat_product_1527946544582.csv
...
The file will be saved in a folder from which you run the script: iphone_product_1557946545582.xls
